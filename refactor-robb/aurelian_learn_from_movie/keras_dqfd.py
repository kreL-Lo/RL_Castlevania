...
def make_env(game='Castlevania-Nes', state='Level1', stack=True, scale_rew=True, scenario='contest',
             is_contest_env=False, action_list=[['LEFT'], ['RIGHT'], ['B']]):
...
def train_expert_model(train_model, target_model, exp_buffer, action_len, batch_size=32, train_steps=180000, update_every=10000,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_weights', help='weights to load',
                        default='./dqfd_training_weights/expert_model_final.h5')
    parser.add_argument(
    ...
    action_list = [['NOOP'], ['LEFT'], ['RIGHT'], [
        'LEFT', 'B'], ['RIGHT', 'B'], ['DOWN'], ['B']]
    ...
    if bool(int(args.train_expert)):
        ...
        train_network(env, init_model, tgt_model, expert_buffer, replay_buffer,
                      n_action, max_timesteps=1000000)  # ,min_buffer_size=50
